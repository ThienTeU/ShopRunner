 ...
 * @author admin
 */
@WebServlet(name="CheckExistProductPriceIdServlet", urlPatterns={"/CheckExistProductPriceIdServlet"})
public class CheckExistProductPriceIdServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            exists = dao.isExistedProductPriceId(productprice_id);
